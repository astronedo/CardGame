...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // after creating the card identities, the card is shuffled, then I stored the
        // shuffled cards into an array to make it its own identity
        ...
        int userScore = 0;
        for (int i = 0; i < 26; i++) {// we need a for loop inside for loop for each item inside array to be compared
                                      // to all items inside array
